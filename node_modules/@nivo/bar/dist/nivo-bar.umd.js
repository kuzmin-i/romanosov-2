(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@nivo/axes'), require('@nivo/annotations'), require('react/jsx-runtime'), require('@nivo/legends'), require('@nivo/core'), require('react'), require('@nivo/scales'), require('d3-shape'), require('lodash/uniqBy'), require('@react-spring/web'), require('@nivo/tooltip'), require('@nivo/colors')) :
  typeof define === 'function' && define.amd ? define(['exports', '@nivo/axes', '@nivo/annotations', 'react/jsx-runtime', '@nivo/legends', '@nivo/core', 'react', '@nivo/scales', 'd3-shape', 'lodash/uniqBy', '@react-spring/web', '@nivo/tooltip', '@nivo/colors'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.nivo, global.nivo, global['react/jsx-runtime'], global.nivo, global.nivo, global.React, global.nivo, global.d3, global['lodash/uniqBy'], global['@react-spring/web'], global.nivo, global.nivo));
}(this, (function (exports, axes, annotations, jsxRuntime, legends, core, react, scales, d3Shape, _uniqBy, web, tooltip, colors) { 'use strict';
